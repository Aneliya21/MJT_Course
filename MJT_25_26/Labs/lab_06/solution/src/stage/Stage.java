...
public final class Stage<I, O> {
    ...
    public static <I, O> Stage<I, O> start(Step<I, O> initialStep) {
        if (initialStep == null) {
            throw new IllegalArgumentException("InitialStep cannot be null");
        }
     ...
     * The returned stage updates the output type to {@code NewO}.
     *
     * @param step the step to add
     * @param <NewO> the output type of the new step
     * @return this stage instance cast to have output type {@code NewO}
     *
