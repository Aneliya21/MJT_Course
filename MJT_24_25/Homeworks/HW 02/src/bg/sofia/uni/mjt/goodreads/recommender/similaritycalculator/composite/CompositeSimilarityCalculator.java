...
public class CompositeSimilarityCalculator implements SimilarityCalculator {
    ...
    public CompositeSimilarityCalculator(Map<SimilarityCalculator,
        Double> similarityCalculatorMap) {
        if (similarityCalculatorMap == null || similarityCalculatorMap.isEmpty()) {
            throw new IllegalArgumentException("The similarity calculator map " +
